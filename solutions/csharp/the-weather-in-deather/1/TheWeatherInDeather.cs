public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook => reading.Equals(new Reading())
        ...
        : (reading.Pressure < 10m && reading.Temperature < 30m, reading.Temperature > 50) switch
        {
            (true, _) => Outlook.Cool,
            (false, true) => Outlook.Good,
            _ => Outlook.Warm
        };

    public Outlook LongTermOutlook => (reading.WindDirection, reading.Temperature > 20m) switch
    {
        (WindDirection.Southerly, _) => Outlook.Good,
        (WindDirection.Easterly, true) => Outlook.Good,
        (WindDirection.Northerly, _) => Outlook.Cool,
        (WindDirection.Easterly, false) => Outlook.Warm,
